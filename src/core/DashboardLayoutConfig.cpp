...
namespace DashboardLayout {
    ...
    const char* ToConfigString(WidgetId id) {
        switch (id) {
        case WidgetId::LiveRoster:
            return "live_roster";
        case WidgetId::LiveMatchStats:
            return "live_match_stats";
        case WidgetId::SessionStats:
            return "session_stats";
        case WidgetId::MmrGraph:
            return "mmr_graph";
        case WidgetId::StreaksStats:
            return "streaks_stats";
        case WidgetId::GamemodeBreakdown:
            return "gamemode_breakdown";
        case WidgetId::LobbyRanks:
            return "lobby_ranks";
        case WidgetId::DemoTracker:
            return "demo_tracker";
        case WidgetId::PreviousGames:
    ...
    const char* GetWidgetDisplayName(WidgetId id) {
        ...
        case WidgetId::GamemodeBreakdown:
            return "Gamemode Breakdown";
        case WidgetId::LobbyRanks:
            return "Lobby Ranks";
        case WidgetId::DemoTracker:
            return "Demolition Tracker";
        case WidgetId::PreviousGames:
