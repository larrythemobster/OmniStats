...
namespace RenderHelper {
    ...
    void Record(int winsWith, int lossesWith, int winsAgainst, int lossesAgainst,
        ...
        if (hasWith) {
            ...
            ImGui::PushFont(fonts.small);
            ImGui::SameLine(0, 0);
            ImGui::TextColored(Format::C(cfg.themeMuted), "W ");
            ImGui::PopFont();
            ImGui::PushFont(fonts.mono);
            ImGui::SameLine(0, 0);
            ImGui::TextColored(Format::C(cfg.themeText), "%d", lossesWith);
            ImGui::PopFont();
            ImGui::PushFont(fonts.small);
            ImGui::SameLine(0, 0);
            ImGui::TextColored(Format::C(cfg.themeMuted), "L with");
            ImGui::PopFont();
        }
        ...
        if (hasWith && hasAgainst) {
            ...
            ImGui::TextColored(Format::C(cfg.themeMuted), " / ");
            ImGui::PopFont();
        }
        ...
        if (hasAgainst) {
            ...
            ImGui::PushFont(fonts.mono);
            ImGui::SameLine(0, 0);
            ImGui::TextColored(Format::C(cfg.themeText), "%d", lossesAgainst);
            ImGui::PopFont();
            ImGui::PushFont(fonts.small);
            ImGui::SameLine(0, 0);
            ImGui::TextColored(Format::C(cfg.themeMuted), "L vs");
            ImGui::PopFont();
        }
    }
