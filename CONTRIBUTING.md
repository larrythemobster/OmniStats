...
Report vulnerabilities privately according to [SECURITY.md](SECURITY.md). Never post credentials, tokens, crash dumps, private endpoints, personal data, or exploitable security details in a public issue.
...
- Code or assets copied without permission
...
├── resources/             # Icons, images, resource scripts, and asset records
├── scripts/               # Release and validation scripts
├── docs/                  # Architecture, privacy, build, and release documentation
...
- Update `vcpkg.json`, CMake, documentation, and third-party notices together.
- Do not add copyrighted game or service assets without permission to redistribute them.
...
- [ ] New dependencies and assets have license and provenance records.
